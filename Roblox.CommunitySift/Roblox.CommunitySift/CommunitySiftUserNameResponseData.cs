...
internal class CommunitySiftUserNameResponseData
{
	[JsonProperty("risk")]
	...
	public bool PrimaryRuleResponse { get; set; }

	[JsonProperty("secondary_rule_response")]
	public bool SecondaryRuleResponse { get; set; }

	[JsonProperty("primary_hashed")]
	public string PrimaryHashed { get; set; }
