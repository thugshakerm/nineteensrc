...
public class CommunitySiftChatRequest : ICommunitySiftChatRequest
{
	/// <summary>
	...
	public CommunitySiftChatRequest(long userId, string userName, bool isUnder13, string text, string server, string room)
	{
		UserId = userId;
		UserName = userName;
		IsUnder13 = isUnder13;
