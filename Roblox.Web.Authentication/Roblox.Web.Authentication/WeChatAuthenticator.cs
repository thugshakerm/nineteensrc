...
public class WeChatAuthenticator : IWeChatAuthenticator
{
	private readonly ISettings _Settings;

	private readonly ISessionFactory _SessionFactory;

	public WeChatAuthenticator(ISessionFactory sessionFactory)
		: this(Settings.Default, sessionFactory)
	{
	}

	internal WeChatAuthenticator(ISettings settings, ISessionFactory sessionFactory)
	{
