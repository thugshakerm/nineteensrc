...
/// <summary>
/// RobloxDynamoDbClient default settings <see cref="T:Roblox.Amazon.DynamoDb.RobloxDynamoDbClient" />.
/// </summary>
public sealed class RobloxDynamoDbClientDefaultSettings : IEquatable<RobloxDynamoDbClientDefaultSettings>
{
	/// <summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:Roblox.Amazon.DynamoDb.RobloxDynamoDbClientDefaultSettings" /> class.
	/// </summary>
	...
	public RobloxDynamoDbClientDefaultSettings(bool isCircuitBreakerEnabled, bool isAsyncRequestTimeoutEnabled, bool isThrottleRetriesEnabled, TimeSpan requestTimeout, TimeSpan readWriteTimeout, int failuresAllowedBeforeCircuitBreakerTrip, TimeSpan circuitBreakerRetryInterval, int maxErrorRetry)
	{
	...
	public override bool Equals(object obj)
	{
		...
		{
			return Equals((RobloxDynamoDbClientDefaultSettings)obj);
		}
		return false;
	}
	...
	/// </returns>
	public bool Equals(RobloxDynamoDbClientDefaultSettings other)
	{
		if (other == null)
		{
			return false;
