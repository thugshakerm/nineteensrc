...
/// <summary>
/// RobloxFirehoseClient default settings <see cref="T:Roblox.Amazon.Firehose.RobloxFirehoseClient" />.
/// </summary>
public sealed class RobloxFirehoseClientDefaultSettings : IEquatable<RobloxFirehoseClientDefaultSettings>
{
	/// <summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:Roblox.Amazon.Firehose.RobloxFirehoseClientDefaultSettings" /> class.
	/// </summary>
	...
	public RobloxFirehoseClientDefaultSettings(bool isCircuitBreakerEnabled, bool isAsyncRequestTimeoutEnabled, bool isThrottleRetriesEnabled, TimeSpan requestTimeout, TimeSpan readWriteTimeout, int failuresAllowedBeforeCircuitBreakerTrip, TimeSpan circuitBreakerRetryInterval, int maxErrorRetry)
	{
	...
	public override bool Equals(object obj)
	{
		...
		{
			return Equals((RobloxFirehoseClientDefaultSettings)obj);
		}
		return false;
	}
	...
	/// </returns>
	public bool Equals(RobloxFirehoseClientDefaultSettings other)
	{
		if (other == null)
		{
			return false;
