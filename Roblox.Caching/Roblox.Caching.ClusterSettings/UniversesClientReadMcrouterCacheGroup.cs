...
internal sealed class UniversesClientReadMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
{
	...
	private static UniversesClientReadMcrouterCacheGroup defaultInstance = (UniversesClientReadMcrouterCacheGroup)(object)SettingsBase.Synchronized((SettingsBase)(object)new UniversesClientReadMcrouterCacheGroup());
	...
	public static UniversesClientReadMcrouterCacheGroup Default => defaultInstance;
