...
internal sealed class GroupsServiceMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
{
	...
	private static GroupsServiceMcrouterCacheGroup defaultInstance = (GroupsServiceMcrouterCacheGroup)(object)SettingsBase.Synchronized((SettingsBase)(object)new GroupsServiceMcrouterCacheGroup());
	...
	public static GroupsServiceMcrouterCacheGroup Default => defaultInstance;
