...
internal sealed class UniversesClientReadCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
{
	...
	private static UniversesClientReadCacheGroup defaultInstance = (UniversesClientReadCacheGroup)(object)SettingsBase.Synchronized((SettingsBase)(object)new UniversesClientReadCacheGroup());
	...
	public static UniversesClientReadCacheGroup Default => defaultInstance;
