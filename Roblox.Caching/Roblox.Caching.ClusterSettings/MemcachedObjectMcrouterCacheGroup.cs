...
internal sealed class MemcachedObjectMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
{
	...
	private static MemcachedObjectMcrouterCacheGroup defaultInstance = (MemcachedObjectMcrouterCacheGroup)(object)SettingsBase.Synchronized((SettingsBase)(object)new MemcachedObjectMcrouterCacheGroup());
	...
	public static MemcachedObjectMcrouterCacheGroup Default => defaultInstance;
