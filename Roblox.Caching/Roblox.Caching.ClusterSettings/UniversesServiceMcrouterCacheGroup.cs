...
internal sealed class UniversesServiceMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
{
	...
	private static UniversesServiceMcrouterCacheGroup defaultInstance = (UniversesServiceMcrouterCacheGroup)(object)SettingsBase.Synchronized((SettingsBase)(object)new UniversesServiceMcrouterCacheGroup());
	...
	public static UniversesServiceMcrouterCacheGroup Default => defaultInstance;
