...
internal sealed class FriendsGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
{
	...
	private static FriendsGroup defaultInstance = (FriendsGroup)(object)SettingsBase.Synchronized((SettingsBase)(object)new FriendsGroup());
	...
	public static FriendsGroup Default => defaultInstance;
