...
internal sealed class MemcachedWebMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged, ISamplingSharedCacheClientSettings
{
	...
	private static MemcachedWebMcrouterCacheGroup defaultInstance = (MemcachedWebMcrouterCacheGroup)(object)SettingsBase.Synchronized((SettingsBase)(object)new MemcachedWebMcrouterCacheGroup());
	...
	public static MemcachedWebMcrouterCacheGroup Default => defaultInstance;
	...
	public bool IsForceResetBytesEnabled => (bool)((SettingsBase)this)["IsForceResetBytesEnabled"];
	...
	[DebuggerNonUserCode]
	[DefaultSettingValue("00:01:00")]
	public TimeSpan LogExpiration => (TimeSpan)((SettingsBase)this)["LogExpiration"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("")]
	public string InfluxUrl => (string)((SettingsBase)this)["InfluxUrl"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("")]
	public string InfluxDatabase => (string)((SettingsBase)this)["InfluxDatabase"];
	...
	public TimeSpan SampleLogExpiration => (TimeSpan)((SettingsBase)this)["SampleLogExpiration"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("0")]
	public uint SampleRatePerThousand => (uint)((SettingsBase)this)["SampleRatePerThousand"];
