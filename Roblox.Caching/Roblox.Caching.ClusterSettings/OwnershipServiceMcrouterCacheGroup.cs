...
internal sealed class OwnershipServiceMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
{
	...
	private static OwnershipServiceMcrouterCacheGroup defaultInstance = (OwnershipServiceMcrouterCacheGroup)(object)SettingsBase.Synchronized((SettingsBase)(object)new OwnershipServiceMcrouterCacheGroup());
	...
	public static OwnershipServiceMcrouterCacheGroup Default => defaultInstance;
