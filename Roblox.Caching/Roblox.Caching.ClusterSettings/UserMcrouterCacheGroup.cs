...
internal sealed class UserMcrouterCacheGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
{
	...
	private static UserMcrouterCacheGroup defaultInstance = (UserMcrouterCacheGroup)(object)SettingsBase.Synchronized((SettingsBase)(object)new UserMcrouterCacheGroup());
	...
	public static UserMcrouterCacheGroup Default => defaultInstance;
