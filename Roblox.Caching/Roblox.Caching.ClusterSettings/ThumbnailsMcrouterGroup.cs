...
internal sealed class ThumbnailsMcrouterGroup : ApplicationSettingsBase, IExposedMemCachedClientSettings, INotifyPropertyChanged
{
	...
	private static ThumbnailsMcrouterGroup defaultInstance = (ThumbnailsMcrouterGroup)(object)SettingsBase.Synchronized((SettingsBase)(object)new ThumbnailsMcrouterGroup());
	...
	public static ThumbnailsMcrouterGroup Default => defaultInstance;
