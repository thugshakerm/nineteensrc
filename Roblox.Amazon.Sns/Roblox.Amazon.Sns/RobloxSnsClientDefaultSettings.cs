...
/// </summary>
public sealed class RobloxSnsClientDefaultSettings : IEquatable<RobloxSnsClientDefaultSettings>
{
	/// <summary>
	...
	public RobloxSnsClientDefaultSettings(bool isCircuitBreakerEnabled, bool isAsyncRequestTimeoutEnabled, bool isThrottleRetriesEnabled, TimeSpan requestTimeout, TimeSpan readWriteTimeout, int failuresAllowedBeforeCircuitBreakerTrip, TimeSpan circuitBreakerRetryInterval, int maxErrorRetry)
	{
	...
	public override bool Equals(object obj)
	{
		...
		{
			return Equals((RobloxSnsClientDefaultSettings)obj);
		}
		return false;
	}
	...
	/// </returns>
	public bool Equals(RobloxSnsClientDefaultSettings other)
	{
		if (other == null)
		{
			return false;
