...
public class GrantedAssetListActivationTaskDAL
{
	private long _ID;
	...
	internal GrantedAssetListActivationTaskDAL()
	{
	}
	...
	internal void Delete()
	{
		...
		EntityHelper.DoEntityDALDelete(new DbInfo(ConnectionString, "[dbo].[GrantedAssetListActivationTasks_DeleteGrantedAssetListActivationTaskByID]", queryParameters));
	}
	...
	internal void Insert()
	{
		...
		_ID = EntityHelper.DoEntityDALInsert<long>(new DbInfo(ConnectionString, "[dbo].[GrantedAssetListActivationTasks_InsertGrantedAssetListActivationTask]", new SqlParameter("@ID", SqlDbType.BigInt), queryParameters));
	}
	...
	internal void Update()
	{
		...
		queryParameters.Add(new SqlParameter("@Created", _Created));
		queryParameters.Add(new SqlParameter("@Updated", _Updated));
		EntityHelper.DoEntityDALUpdate(new DbInfo(ConnectionString, "[dbo].[GrantedAssetListActivationTasks_UpdateGrantedAssetListActivationTaskByID]", queryParameters));
	}

	private static GrantedAssetListActivationTaskDAL BuildDAL(SqlDataReader reader)
	{
		GrantedAssetListActivationTaskDAL dal = new GrantedAssetListActivationTaskDAL();
		while (reader.Read())
		{
	...
	internal static GrantedAssetListActivationTaskDAL Get(long id)
	{
		if (id == 0L)
		{
			return null;
		...
		return EntityHelper.GetEntityDAL(new DbInfo(ConnectionString, "[dbo].[GrantedAssetListActivationTasks_GetGrantedAssetListActivationTaskByID]", queryParameters), BuildDAL);
	}

	internal static EntityHelper.GetOrCreateDALWrapper<GrantedAssetListActivationTaskDAL> GetOrCreate(long premiumFeatureActivationTaskID)
	{
		...
		return EntityHelper.GetOrCreateEntityDAL(new DbInfo(ConnectionString, "[dbo].[GrantedAssetListActivationTasks_GetOrCreateGrantedAssetListActivationTask]", queryParameters), BuildDAL);
	}
	...
	internal static ICollection<long> LeaseTasks(Guid workerId, int leaseDurationInMinutes, int maxToLease)
	{
		...
		return EntityHelper.GetDataEntityIDCollection<long>(new DbInfo(ConnectionString, "[dbo].[GrantedAssetListActivationTasks_LeaseTasks]", queryParameters));
	}
}
