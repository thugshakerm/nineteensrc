...
/// </summary>
internal class NotificationStreamResources_zh_cjv : NotificationStreamResources_en_us, INotificationStreamResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Accept"
	...
	public NotificationStreamResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
