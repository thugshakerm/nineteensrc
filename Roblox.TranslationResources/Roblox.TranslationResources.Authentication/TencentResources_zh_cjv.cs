...
/// </summary>
internal class TencentResources_zh_cjv : TencentResources_en_us, ITencentResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.QQLogin"
	...
	public TencentResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
