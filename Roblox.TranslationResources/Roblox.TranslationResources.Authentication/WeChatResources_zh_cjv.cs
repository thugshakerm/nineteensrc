...
/// </summary>
internal class WeChatResources_zh_cjv : WeChatResources_en_us, IWeChatResources, ITranslationResources
{
	/// <summary>
	...
	public WeChatResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
