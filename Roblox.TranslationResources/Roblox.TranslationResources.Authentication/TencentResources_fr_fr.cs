...
/// </summary>
internal class TencentResources_fr_fr : TencentResources_en_us, ITencentResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.QQLogin"
	...
	/// </summary>
	public override string ActionQQLogin => "Connexion QQ";
	...
	public TencentResources_fr_fr(TranslationResourceState state)
		: base(state)
	{
	}
