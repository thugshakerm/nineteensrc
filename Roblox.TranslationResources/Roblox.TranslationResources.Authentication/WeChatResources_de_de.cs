...
/// </summary>
internal class WeChatResources_de_de : WeChatResources_en_us, IWeChatResources, ITranslationResources
{
	/// <summary>
	...
	public WeChatResources_de_de(TranslationResourceState state)
		: base(state)
	{
	}
