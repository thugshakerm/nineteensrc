...
/// </summary>
internal class WeChatResources_pt_br : WeChatResources_en_us, IWeChatResources, ITranslationResources
{
	/// <summary>
	...
	public WeChatResources_pt_br(TranslationResourceState state)
		: base(state)
	{
	}
