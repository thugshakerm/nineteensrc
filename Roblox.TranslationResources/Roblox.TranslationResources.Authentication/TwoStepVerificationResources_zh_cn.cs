...
/// </summary>
internal class TwoStepVerificationResources_zh_cn : TwoStepVerificationResources_en_us, ITwoStepVerificationResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Cancel"
	...
	public TwoStepVerificationResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
