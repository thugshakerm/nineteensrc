...
/// </summary>
internal class CaptchaResources_zh_cjv : CaptchaResources_en_us, ICaptchaResources, ITranslationResources
{
	/// <summary>
	...
	public CaptchaResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
