...
/// </summary>
internal class CommonEmailResources_pt_br : CommonEmailResources_en_us, ICommonEmailResources, ITranslationResources
{
	public CommonEmailResources_pt_br(TranslationResourceState state)
		: base(state)
	{
	}
	...
	{
		return $"Esta mensagem foi gerada por {environmentIdentifier}.";
	}
