...
/// </summary>
internal class GameGearResources_fr_fr : GameGearResources_en_us, IGameGearResources, ITranslationResources
{
	/// <summary>
	/// Key: "Heading.GearForThisGame"
	/// English String: "Gear"
	/// </summary>
	public override string HeadingGearForThisGame => "Équipement";
	...
	public GameGearResources_fr_fr(TranslationResourceState state)
		: base(state)
	{
	}
