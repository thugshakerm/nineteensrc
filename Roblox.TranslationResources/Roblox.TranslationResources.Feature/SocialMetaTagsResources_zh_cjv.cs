...
/// </summary>
internal class SocialMetaTagsResources_zh_cjv : SocialMetaTagsResources_en_us, ISocialMetaTagsResources, ITranslationResources
{
	/// <summary>
	...
	public SocialMetaTagsResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
