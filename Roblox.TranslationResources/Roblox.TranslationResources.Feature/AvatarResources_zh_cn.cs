...
/// </summary>
internal class AvatarResources_zh_cn : AvatarResources_en_us, IAvatarResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Advanced"
	...
	public AvatarResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
