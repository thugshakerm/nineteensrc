...
/// </summary>
internal class DevelopLandingResources_zh_cjv : DevelopLandingResources_en_us, IDevelopLandingResources, ITranslationResources
{
	/// <summary>
	...
	public DevelopLandingResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
