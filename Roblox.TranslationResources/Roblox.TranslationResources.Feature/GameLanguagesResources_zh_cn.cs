...
/// </summary>
internal class GameLanguagesResources_zh_cn : GameLanguagesResources_en_us, IGameLanguagesResources, ITranslationResources
{
	/// <summary>
	...
	public GameLanguagesResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
