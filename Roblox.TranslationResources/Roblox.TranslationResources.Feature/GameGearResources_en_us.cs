...
internal class GameGearResources_en_us : TranslationResourcesBase, IGameGearResources, ITranslationResources
{
	...
	/// English String: "Gear"
	/// </summary>
	public virtual string HeadingGearForThisGame => "Gear";
	...
	public GameGearResources_en_us(TranslationResourceState state)
		: base(state)
	{
