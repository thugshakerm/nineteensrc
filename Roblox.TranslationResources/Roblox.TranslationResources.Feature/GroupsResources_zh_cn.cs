...
/// </summary>
internal class GroupsResources_zh_cn : GroupsResources_en_us, IGroupsResources, ITranslationResources
{
	/// <summary>
	...
	public GroupsResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
