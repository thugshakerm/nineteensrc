...
/// </summary>
internal class TranslationRolesResources_zh_cjv : TranslationRolesResources_en_us, ITranslationRolesResources, ITranslationResources
{
	/// <summary>
	...
	public TranslationRolesResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
