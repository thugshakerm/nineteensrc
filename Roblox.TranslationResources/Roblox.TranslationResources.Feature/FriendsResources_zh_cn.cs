...
/// </summary>
internal class FriendsResources_zh_cn : FriendsResources_en_us, IFriendsResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Accept"
	...
	public FriendsResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
