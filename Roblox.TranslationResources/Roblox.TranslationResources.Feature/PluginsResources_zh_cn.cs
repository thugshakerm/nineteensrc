...
/// </summary>
internal class PluginsResources_zh_cn : PluginsResources_en_us, IPluginsResources, ITranslationResources
{
	/// <summary>
	/// Key: "Label.ErrorBody"
	...
	public PluginsResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
