...
/// </summary>
internal class ProfileResources_zh_cjv : ProfileResources_en_us, IProfileResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Accept"
	...
	public ProfileResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
