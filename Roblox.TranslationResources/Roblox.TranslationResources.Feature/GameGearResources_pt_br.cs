...
/// </summary>
internal class GameGearResources_pt_br : GameGearResources_en_us, IGameGearResources, ITranslationResources
{
	/// <summary>
	/// Key: "Heading.GearForThisGame"
	/// English String: "Gear"
	/// </summary>
	public override string HeadingGearForThisGame => "Equipamentos";
	...
	public GameGearResources_pt_br(TranslationResourceState state)
		: base(state)
	{
	}
