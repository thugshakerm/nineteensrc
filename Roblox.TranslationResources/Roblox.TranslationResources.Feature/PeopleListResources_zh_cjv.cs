...
/// </summary>
internal class PeopleListResources_zh_cjv : PeopleListResources_en_us, IPeopleListResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Buy"
	...
	public PeopleListResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
