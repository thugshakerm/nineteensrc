...
/// </summary>
internal class VotingPanelResources_zh_cn : VotingPanelResources_en_us, IVotingPanelResources, ITranslationResources
{
	/// <summary>
	/// Key: "Label.Accept"
	...
	public VotingPanelResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
