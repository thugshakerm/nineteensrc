...
/// </summary>
internal class GameGearResources_zh_cn : GameGearResources_en_us, IGameGearResources, ITranslationResources
{
	/// <summary>
	...
	public GameGearResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
