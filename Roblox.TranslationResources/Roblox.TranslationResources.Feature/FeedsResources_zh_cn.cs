...
/// </summary>
internal class FeedsResources_zh_cn : FeedsResources_en_us, IFeedsResources, ITranslationResources
{
	/// <summary>
	...
	public FeedsResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
