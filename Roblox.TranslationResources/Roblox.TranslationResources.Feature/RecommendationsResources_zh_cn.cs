...
/// </summary>
internal class RecommendationsResources_zh_cn : RecommendationsResources_en_us, IRecommendationsResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Buy"
	...
	public RecommendationsResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
