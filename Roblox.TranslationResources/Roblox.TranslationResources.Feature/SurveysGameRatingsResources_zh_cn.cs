...
/// </summary>
internal class SurveysGameRatingsResources_zh_cn : SurveysGameRatingsResources_en_us, ISurveysGameRatingsResources, ITranslationResources
{
	/// <summary>
	...
	public SurveysGameRatingsResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
