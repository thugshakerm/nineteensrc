...
/// </summary>
internal class CreditCardExpiringModalResources_zh_cjv : CreditCardExpiringModalResources_en_us, ICreditCardExpiringModalResources, ITranslationResources
{
	/// <summary>
	...
	public CreditCardExpiringModalResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
