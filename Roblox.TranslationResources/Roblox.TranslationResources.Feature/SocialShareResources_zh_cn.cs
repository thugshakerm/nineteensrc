...
/// </summary>
internal class SocialShareResources_zh_cn : SocialShareResources_en_us, ISocialShareResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Share"
	...
	public SocialShareResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
