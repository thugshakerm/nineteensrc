...
/// </summary>
internal class SocialShareResources_de_de : SocialShareResources_en_us, ISocialShareResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Share"
	...
	public SocialShareResources_de_de(TranslationResourceState state)
		: base(state)
	{
	}
