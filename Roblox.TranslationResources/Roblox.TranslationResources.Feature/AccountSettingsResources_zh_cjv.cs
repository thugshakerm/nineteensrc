...
/// </summary>
internal class AccountSettingsResources_zh_cjv : AccountSettingsResources_en_us, IAccountSettingsResources, ITranslationResources
{
	/// <summary>
	...
	public AccountSettingsResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
