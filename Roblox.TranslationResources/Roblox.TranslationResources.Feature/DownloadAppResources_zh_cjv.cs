...
/// </summary>
internal class DownloadAppResources_zh_cjv : DownloadAppResources_en_us, IDownloadAppResources, ITranslationResources
{
	/// <summary>
	...
	public DownloadAppResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
