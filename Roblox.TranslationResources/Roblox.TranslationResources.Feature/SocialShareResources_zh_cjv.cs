...
/// </summary>
internal class SocialShareResources_zh_cjv : SocialShareResources_en_us, ISocialShareResources, ITranslationResources
{
	/// <summary>
	/// Key: "Action.Share"
	...
	public SocialShareResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
