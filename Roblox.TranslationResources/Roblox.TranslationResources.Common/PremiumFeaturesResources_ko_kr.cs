...
/// </summary>
internal class PremiumFeaturesResources_ko_kr : PremiumFeaturesResources_en_us, IPremiumFeaturesResources, ITranslationResources
{
	/// <summary>
	...
	public PremiumFeaturesResources_ko_kr(TranslationResourceState state)
		: base(state)
	{
	}
