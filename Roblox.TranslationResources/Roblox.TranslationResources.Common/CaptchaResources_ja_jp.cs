...
internal class CaptchaResources_ja_jp : CaptchaResources_en_us, ICaptchaResources, ITranslationResources
{
	...
	/// </summary>
	public override string ResponseCaptchaErrorFailedToLoad => "ユーザーが行った操作であることを検証する必要があります。ブラウザのブロッカーをオフにするか、別のブラウザでもう一度お試しください。";
	...
	/// </summary>
	public override string ResponseCaptchaErrorFailedToVerify => "一時的なエラーです。しばらくしてからもう一度お試しください。";
	...
	/// English String: "Temporary error. Please try again in a few minutes"
	/// </summary>
	public override string ResponseCaptchaErrorVerifyFailed => "一時的なエラーです。しばらくしてからもう一度お試しください。";
	...
	{
		return "ユーザーが行った操作であることを検証する必要があります。ブラウザのブロッカーをオフにするか、別のブラウザでもう一度お試しください。";
	}

	protected override string _GetTemplateForResponseCaptchaErrorFailedToVerify()
	{
		return "一時的なエラーです。しばらくしてからもう一度お試しください。";
	}
