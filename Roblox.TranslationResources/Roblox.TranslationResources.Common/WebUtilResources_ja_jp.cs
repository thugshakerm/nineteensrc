...
/// </summary>
internal class WebUtilResources_ja_jp : WebUtilResources_en_us, IWebUtilResources, ITranslationResources
{
	public WebUtilResources_ja_jp(TranslationResourceState state)
		: base(state)
	{
	}
