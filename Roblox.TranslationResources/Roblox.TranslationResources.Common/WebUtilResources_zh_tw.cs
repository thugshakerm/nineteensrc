...
/// </summary>
internal class WebUtilResources_zh_tw : WebUtilResources_en_us, IWebUtilResources, ITranslationResources
{
	public WebUtilResources_zh_tw(TranslationResourceState state)
		: base(state)
	{
	}
