...
/// </summary>
internal class PresenceResources_zh_cjv : PresenceResources_en_us, IPresenceResources, ITranslationResources
{
	/// <summary>
	/// Key: "Label.Creating"
	...
	public PresenceResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
