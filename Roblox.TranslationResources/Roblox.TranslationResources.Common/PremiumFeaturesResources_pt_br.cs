...
/// </summary>
internal class PremiumFeaturesResources_pt_br : PremiumFeaturesResources_en_us, IPremiumFeaturesResources, ITranslationResources
{
	/// <summary>
	...
	public PremiumFeaturesResources_pt_br(TranslationResourceState state)
		: base(state)
	{
	}
