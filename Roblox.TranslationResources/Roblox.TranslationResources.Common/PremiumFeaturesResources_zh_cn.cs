...
/// </summary>
internal class PremiumFeaturesResources_zh_cn : PremiumFeaturesResources_en_us, IPremiumFeaturesResources, ITranslationResources
{
	/// <summary>
	...
	public PremiumFeaturesResources_zh_cn(TranslationResourceState state)
		: base(state)
	{
	}
