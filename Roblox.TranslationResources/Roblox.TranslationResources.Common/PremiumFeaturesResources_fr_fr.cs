...
/// </summary>
internal class PremiumFeaturesResources_fr_fr : PremiumFeaturesResources_en_us, IPremiumFeaturesResources, ITranslationResources
{
	/// <summary>
	...
	public PremiumFeaturesResources_fr_fr(TranslationResourceState state)
		: base(state)
	{
	}
