...
/// </summary>
internal class PremiumFeaturesResources_es_es : PremiumFeaturesResources_en_us, IPremiumFeaturesResources, ITranslationResources
{
	/// <summary>
	...
	public PremiumFeaturesResources_es_es(TranslationResourceState state)
		: base(state)
	{
	}
