...
/// </summary>
internal class AlertsAndOptionsResources_zh_cjv : AlertsAndOptionsResources_en_us, IAlertsAndOptionsResources, ITranslationResources
{
	/// <summary>
	/// Key: "Label.sBuyRobux"
	...
	public AlertsAndOptionsResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
