...
/// </summary>
internal class TermsOfServiceResources_zh_cjv : TermsOfServiceResources_en_us, ITermsOfServiceResources, ITranslationResources
{
	/// <summary>
	...
	public TermsOfServiceResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
