...
/// </summary>
internal class PremiumFeaturesResources_zh_cjv : PremiumFeaturesResources_en_us, IPremiumFeaturesResources, ITranslationResources
{
	/// <summary>
	...
	public PremiumFeaturesResources_zh_cjv(TranslationResourceState state)
		: base(state)
	{
	}
