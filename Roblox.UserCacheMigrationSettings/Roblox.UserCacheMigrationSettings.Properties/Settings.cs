...
namespace Roblox.UserCacheMigrationSettings.Properties;
...
public sealed class Settings : ApplicationSettingsBase
{
	...
	public MigrationStateChange UserMigrationState => (MigrationStateChange)((SettingsBase)this)["UserMigrationState"];

	[ApplicationScopedSetting]
	[DebuggerNonUserCode]
	[DefaultSettingValue("UserMcrouterCacheGroup")]
	public string UserMigrationGroupName => (string)((SettingsBase)this)["UserMigrationGroupName"];
